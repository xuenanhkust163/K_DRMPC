...
def main():
    ...
    if ENABLE_ROBUSTNESS_ANALYSIS:
        ...
        print("# 鲁棒性分析（表11）")
        print("#" * 60)
        run_robustness_analysis(lusail, model, D, norm_params, max_steps=500)
    else:
    ...
    if ENABLE_SENSITIVITY_ANALYSIS:
        ...
        print("#" * 60)
        run_sensitivity_theta(lusail, model, D, norm_params, dist_gen,
                              max_steps=500)
        ...
        print("#" * 60)
        run_sensitivity_epsilon(lusail, model, D, norm_params, dist_gen,
                                max_steps=500)
    else:
